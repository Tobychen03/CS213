...
/**
 * Order class
 * manipulate the information of customer's order
...
public class Order implements Customizable {
    ...
    public String toString() {
        ...
        String str = "Number of Order: " + orderNum + ", Number of item: " + cnt + ", sub Price: "+ decimalFormat.format(sub) + ", tax: " + decimalFormat.format(tax) +", total: " + decimalFormat.format(total_price) + ", Information: \n";
        for (MenuItem menuItem: lists) {
